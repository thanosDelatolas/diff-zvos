...
class SDFeatureExtractor:
    ...
    def forward(self,
        ...
        if layer is not None:
            unet_ft_all = unet_ft_all[layer]
            unet_ft = unet_ft_all.mean(0, keepdim=True)
        else:
            # # for ensem
            unet_ft = [feat.mean(0, keepdim=True) for feat in unet_ft_all]  
        return unet_ft
